...
namespace DevMailCenter.Core.Migrations
{
    ...
    [Migration("20241114114042_EmailPriority Added")]
    partial class EmailPriorityAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DevMailCenter.Models.Email", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 14, 11, 40, 42, 109, DateTimeKind.Utc).AddTicks(1944))
            ...
            modelBuilder.Entity("DevMailCenter.Models.MailServer", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 14, 11, 40, 42, 108, DateTimeKind.Utc).AddTicks(6399))
            ...
            modelBuilder.Entity("DevMailCenter.Models.MailServerSettings", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 14, 11, 40, 42, 109, DateTimeKind.Utc).AddTicks(756))
